# Module google/image/imagenet/inception_v2/classification/1

**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/image/imagenet/inception_v2/classification/1.tar.gz
...
[`google/image/imagenet/inception_v2/feature_vector/1`](../feature_vector/1.md)
...
```python
module = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/image/imagenet/inception_v2/classification/1.tar.gz")

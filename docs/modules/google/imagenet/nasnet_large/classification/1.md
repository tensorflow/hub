# Module google/imagenet/nasnet_large/classification/1

**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/imagenet/nasnet_large/classification/1.tar.gz
...
[`google/imagenet/nasnet_large/feature_vector/1`](../feature_vector/1.md)
...
```python
module = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/imagenet/nasnet_large/classification/1.tar.gz")

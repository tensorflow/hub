...
[![Open Colab notebok](../../../images/open_in_colab.png){width="200px"}](//colab.research.google.com/github/tensorflow/hub/blob/master/examples/colab/semantic_similarity_with_tf_hub_universal_encoder_lite.ipynb)

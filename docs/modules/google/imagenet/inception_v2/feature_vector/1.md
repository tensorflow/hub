...
**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/imagenet/inception_v2/feature_vector/1.tar.gz
...
```python
module = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/imagenet/inception_v2/feature_vector/1.tar.gz")

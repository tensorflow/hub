...
[This section of the notebook](https://colab.research.google.com/github/tensorflow/hub/blob/master/examples/colab/semantic_similarity_with_tf_hub_universal_encoder.ipynb#scrollTo=O0t1i3wNKU30)
shows how to train a simple binary text classifier on top of the Universal
Sentence Encoder. We use the Stanford IMDB sentiment analysis dataset for this
example. The Universal Sentence Encoder was partly trained with custom text
classification tasks in mind. It can be trained to perform a wide variety of
classification tasks often with a very small amount of labeled examples.

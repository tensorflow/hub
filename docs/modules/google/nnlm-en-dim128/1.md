...
**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/nnlm-en-dim128/1.tar.gz
...
#### Example use
```
embed = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/nnlm-en-dim128/1.tar.gz")

...
**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/imagenet/resnet_v2_152/classification/1.tar.gz
...
[`google/imagenet/resnet_v2_152/feature_vector/1`](../feature_vector/1.md)
...
```python
module = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/imagenet/resnet_v2_152/classification/1.tar.gz")

# Module google/imagenet/resnet_v1_50/feature_vector/1

**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/imagenet/resnet_v1_50/feature_vector/1.tar.gz
...
```python
module = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/imagenet/resnet_v1_50/feature_vector/1.tar.gz")

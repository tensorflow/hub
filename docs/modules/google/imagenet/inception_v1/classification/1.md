# Module google/imagenet/inception_v1/classification/1

**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/imagenet/inception_v1/classification/1.tar.gz
...
```python
module = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/imagenet/inception_v1/classification/1.tar.gz")

# Module google/nnlm-de-dim50-with-normalization/1
Token based text embedding trained on German Google News 30B corpus.

**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/nnlm-de-dim50-with-normalization/1.tar.gz
...
#### Example use
```
embed = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/nnlm-de-dim50-with-normalization/1.tar.gz")

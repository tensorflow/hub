...
**Module URL:** [https://tfhub.dev/google/elmo/2](https://tfhub.dev/google/elmo/2)
...
### Inputs
The module [defines two signatures](https://www.tensorflow.org/hub/basics#applying_a_module):
`default`, and `tokens`.
...
#### Version 1
*  Initial release ([link](https://tfhub.dev/google/elmo/1)).

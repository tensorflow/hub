...
Feature vectors of images with ResNet V1 152 trained on ImageNet (ILSVRC-2012-CLS).
...
[`google/imagenet/resnet_v1_152/classification/1`](https://tfhub.dev/google/imagenet/resnet_v1_152/classification/1)
instead.

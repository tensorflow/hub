...
**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/imagenet/mobilenet_v1_050_224/quantops/classification/1.tar.gz
...
```python
module = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/imagenet/mobilenet_v1_050_224/quantops/classification/1.tar.gz")

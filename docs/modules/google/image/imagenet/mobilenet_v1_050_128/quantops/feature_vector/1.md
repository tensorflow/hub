# Module google/image/imagenet/mobilenet_v1_050_128/quantops/feature_vector/1

**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/image/imagenet/mobilenet_v1_050_128/quantops/feature_vector/1.tar.gz
...
[`google/image/imagenet/mobilenet_v1_050_128/quantops/classification/1`](../classification/1.md)
instead.
...
```python
module = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/image/imagenet/mobilenet_v1_050_128/quantops/feature_vector/1.tar.gz")

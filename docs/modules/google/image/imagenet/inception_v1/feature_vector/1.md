# Module google/image/imagenet/inception_v1/feature_vector/1

**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/image/imagenet/inception_v1/feature_vector/1.tar.gz
...
[`google/image/imagenet/inception_v1/classification/1`](../classification/1.md)
instead.
...
module = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/image/imagenet/inception_v1/feature_vector/1.tar.gz")

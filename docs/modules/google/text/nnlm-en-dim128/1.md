...
NNLM text embedding trained on English Google News 200B corpus.
...
#### Example use
```
embed = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/text/nnlm-en-dim128/1.tar.gz")

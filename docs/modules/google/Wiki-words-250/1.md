...
**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/Wiki-words-250/1.tar.gz
...
#### Example use
```
embed = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/Wiki-words-250/1.tar.gz")

# Module google/imagenet/mobilenet_v2_100_128/classification/1

**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/imagenet/mobilenet_v2_100_128/classification/1.tar.gz
...
```python
module = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/imagenet/mobilenet_v2_100_128/classification/1.tar.gz")

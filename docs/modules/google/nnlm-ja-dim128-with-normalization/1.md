...
**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/nnlm-ja-dim128-with-normalization/1.tar.gz
...
#### Example use
```
embed = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/nnlm-ja-dim128-with-normalization/1.tar.gz")

...
**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/imagenet/mobilenet_v1_100_160/quantops/classification/1.tar.gz
...
[`google/imagenet/mobilenet_v1_100_160/quantops/feature_vector/1`](../feature_vector/1.md)
...
```python
module = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/imagenet/mobilenet_v1_100_160/quantops/classification/1.tar.gz")

# Module google/text/nnlm-ja-dim50-with-normalization/1
NNLM text embedding trained on Japanese Google News 6B corpus.

**Module URL:** https://storage.googleapis.com/tfhub-test-modules/google/text/nnlm-ja-dim50-with-normalization/1.tar.gz
...
#### Example use
```
embed = hub.Module("https://storage.googleapis.com/tfhub-test-modules/google/text/nnlm-ja-dim50-with-normalization/1.tar.gz")

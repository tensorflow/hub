...
[![Open Colab notebok](../../../images/open_in_colab.png){width="200px"}](https://colab.research.google.com/github/tensorflow/hub/blob/master/examples/colab/tf_hub_generative_image_module.ipynb)
